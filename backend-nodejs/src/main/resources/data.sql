...
-- ================= HOTELS =================
INSERT INTO hotels (name, description, address, created_at, updated_at)
VALUES
    ('North Wollo Hotel', 'Comfortable stay in Woldia', 'Woldia, North Wollo', NOW(), NOW()),
    ('Blue Nile Inn', 'Cozy hotel near the Blue Nile', 'Woldia, North Wollo', NOW(), NOW())
    ON CONFLICT (name) DO NOTHING;
