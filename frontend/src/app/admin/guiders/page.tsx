    ...
    <div className="min-h-screen bg-gray-200 admin-page">
      ...
      <div className="mb-8 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 p-6 rounded-xl shadow-xl">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-black text-white mb-2">🗺️ Guiders Management</h1>
            <p className="text-blue-200 font-semibold">Manage tour guides and language specialists</p>
          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="h-10 w-10 rounded-full bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center shadow-md">
                          <span className="text-white font-black">{guider.fullName?.charAt(0) || '?'}</span>
                        </div>
                        <div className="ml-4">
                          <div className="text-sm font-black text-gray-900">{guider.fullName}</div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto border-2 border-gray-300">
            ...
            <div className="p-6 space-y-4">
              ...
              <FormInput label="Full Name" name="fullName" value={formData.fullName} onChange={handleInputChange}
                error={formErrors.fullName} placeholder="e.g., Abebe Kebede" required
