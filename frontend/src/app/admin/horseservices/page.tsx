      ...
      <div className="mb-8 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 p-6 rounded-xl shadow-xl">
        <div className="flex justify-between items-center">
          <div>
            ...
            <h1 className="text-3xl font-black text-white mb-2">🐎 Horse Services Management</h1>
            <p className="text-blue-200 font-semibold">Manage horse rental and transportation services</p>
          </div>
          <button
            ...
            {filteredServices.map((service) => (
              <div key={service.id} className="rounded-xl overflow-hidden hover:shadow-xl transition-shadow bg-white shadow-lg">
                ...
                <div className="p-4 bg-amber-50 shadow-inner">
                  ...
                  <div className="mt-3">
                    <span className="inline-block px-3 py-1 text-lg font-black text-green-800 bg-green-200 rounded-full shadow-sm">${service.cost}</span>
                  </div>
