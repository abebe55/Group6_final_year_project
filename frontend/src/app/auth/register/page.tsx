...
export default function RegisterForm({ onSuccess, onLoginClick, onCancel }: Props) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-6 px-4 relative overflow-hidden">
      {/* Background */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-emerald-600 rounded-full mix-blend-screen filter blur-[100px] opacity-20" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-teal-600 rounded-full mix-blend-screen filter blur-[100px] opacity-20" />
      </div>
