...
export default function HotelsPage() {
  ...
  const tourismName = searchParams.get("tourismName") || "this destination";
        ...
        <div className="px-6 py-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-2xl text-slate-400">{hotels.length} accommodations near {tourismName}</p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            {loading ? (
              ...
              <div className="text-center py-24">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">No hotels found</h2>
                <p className="text-xl text-slate-400 mb-8">No accommodations available for this destination yet.</p>
